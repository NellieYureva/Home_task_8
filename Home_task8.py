...
# Домашнее задание 8: Дополнить справочник возможностью копирования данных из одного файла в другой. 
...
def choose_action(phonebook):
    while True: 
        ...
        user_choice = input('1 - Добавить контакт из другого файла\n2 - Найти контакт\n3 - Добавить контакт\n\
4 - Изменить контакт\n5 - Удалить контакт\n6 - Просмотреть все контакты\n0 - Выйти из приложения\n') 
        print()
        if user_choice == '1':
            file_to_add = input ('Введите название файла, из которого надо скописовать контакт: ')
...
def import_data(file_to_add, phonebook):
   with open(file_to_add, 'r', encoding='utf-8') as file_1, open(phonebook, 'a', encoding='utf-8') as file_2:
        lines_to_add = file_1.readlines()
        file_2.writelines(lines_to_add)                           
    
def read_file_to_dict(file_name):
    with open(file_name, 'r', encoding='utf-8') as file:
        lines = file.readlines()
    headers = ['Фамилия', 'Имя', 'Отчество', 'Номер телефона', 'Должность']
    contact_list = []
    for line in lines:
...
def search_parameters():
    ...
    if search_field == '1':
        ...
        search_value = input('Введите должность для поиска: ')
        print()
...
def find_number(contact_list):
    ...
    search_value_dict = {'1': 'Фамилия', '2': 'Имя', '3': 'Отчество', '4': 'Номер телефона', '5': 'Должность'}
    found_contacts = []
...
def get_new_number():
    ...
    return last_name, first_name, patronymic, phone_number, post
...
def change_phone_number(file_name):
    ...
    if field == '1':
        ...
        number_to_change[4] = input('Введите должность: ')
